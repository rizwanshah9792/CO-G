...
const HomePage: React.FC = () => {
  ...
  const handleGetStartedClick = () => {
    if (isAuthenticated) {
      navigate('/tracker'); // Redirect to tracker if logged in
    } else {
  ...
  return (
    <div className="min-h-screen" data-id="ogsf05kuj" data-path="src/pages/HomePage.tsx">
      ...
      <section
        ref={heroRef}
        className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-900 via-purple-900 to-green-900"
        data-id="6mrfjkj8v"
      ...
      >
        ...
        <div className="absolute inset-0 opacity-20" data-id="fnzfdkxmm" data-path="src/pages/HomePage.tsx">
          <div
            className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-500 rounded-full mix-blend-multiply filter blur-xl animate-blob"
            data-id="q16tiei6i"
            data-path="src/pages/HomePage.tsx"
          ></div>
          <div
            className="absolute top-1/3 right-1/4 w-96 h-96 bg-purple-500 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-2000"
            data-id="zjfc7g2d8"
            data-path="src/pages/HomePage.tsx"
          ></div>
          <div
            className="absolute bottom-1/4 left-1/3 w-96 h-96 bg-green-500 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-4000"
            data-id="t5nitehqy"
            data-path="src/pages/HomePage.tsx"
          ></div>
        </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <span
                className="bg-gradient-to-r from-green-400 via-teal-400 to-blue-400 bg-clip-text text-transparent"
                data-id="j9i2dyrwf"
                data-path="src/pages/HomePage.tsx"
              >
                Guardian
            ...
            <motion.p
              ...
              data-path="src/pages/HomePage.tsx"
            >
              Rebalance Your Digital Life. Empowering rural Indian youth to build a healthier relationship with technology through mindful usage tracking and wellness monitoring.
            </motion.p>
            ...
            <motion.div
              ...
              data-path="src/pages/HomePage.tsx"
            >
              {/* Replace Link with Button and handle click dynamically */}
              <Button
                size="lg"
                onClick={handleGetStartedClick}
                className="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white px-8 py-4 text-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-2xl border-2 border-white/20 hover:border-white/40 btn-glow btn-pulse"
                data-id="5igrdx4jl"
                data-path="src/pages/HomePage.tsx"
              >
                Get Started Free
              ...
              <Link to="/videos" data-id="xo2wxkntq" data-path="src/pages/HomePage.tsx">
                <Button
                  variant="outline"
                  size="lg"
                  className="border-2 border-white text-white hover:bg-white hover:text-gray-900 px-8 py-4 text-lg font-semibold transition-all duration-300 transform hover:scale-105 bg-white/10 backdrop-blur-sm shadow-xl btn-outline-enhanced"
                  data-id="19e13z3dd"
                  data-path="src/pages/HomePage.tsx"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-id="0b9nzqz75" data-path="src/pages/HomePage.tsx">
          ...
          >
            ...
            <p
              ...
              data-path="src/pages/HomePage.tsx"
            >
              Our comprehensive platform combines cutting-edge technology with proven wellness strategies to help you develop a healthier relationship with your smartphone.
            </p>
          </motion.div>
              ...
              >
                ...
                >
                  <CardContent className="p-6 text-center" data-id="5r0p5k560" data-path="src/pages/HomePage.tsx">
                    ...
                    <p className="text-gray-600" data-id="uh19qup6n" data-path="src/pages/HomePage.tsx">
                      {feature.description}
                    </p>
                  </CardContent>
                </Card>
        ...
        >
          ...
          >
            ...
            <p
              ...
              data-path="src/pages/HomePage.tsx"
            >
              Start your journey towards mindful technology usage today. Track your progress, build healthier habits, and join a community committed to digital wellness.
            </p>
            ...
            >
              ...
              <Button
                size="lg"
                onClick={handleGetStartedClick}
                className="bg-white text-blue-600 hover:bg-gray-100 px-8 py-4 text-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-xl border-2 border-white/20 btn-glow"
                data-id="k51l34rug"
                data-path="src/pages/HomePage.tsx"
              >
              ...
              <Link to="/tips" data-id="4xpm316yp" data-path="src/pages/HomePage.tsx">
                <Button
                  variant="outline"
                  size="lg"
                  className="border-2 border-white text-white hover:bg-white hover:text-green-600 px-8 py-4 text-lg font-semibold transition-all duration-300 transform hover:scale-105 bg-white/10 backdrop-blur-sm shadow-xl btn-outline-enhanced"
                  data-id="q22mc05l8"
                  data-path="src/pages/HomePage.tsx"
                >
