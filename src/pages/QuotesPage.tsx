    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50 py-12" data-id="a2j8iuosm" data-path="src/pages/QuotesPage.tsx">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" data-id="jh4l6kvmb" data-path="src/pages/QuotesPage.tsx">
        ...
        <motion.div
          ...
          data-id="ri35nf5bc"
          data-path="src/pages/QuotesPage.tsx"
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto" data-id="7wc2th7s6" data-path="src/pages/QuotesPage.tsx">
            Find motivation and wisdom to guide your journey towards mindful technology use and digital wellness.
          </p>
        </motion.div>
            ...
            {currentQuote && (
              ...
              >
                <Card className="border-0 shadow-2xl overflow-hidden" data-id="3i77thk7u" data-path="src/pages/QuotesPage.tsx">
                  <div
                    className={`h-2 bg-gradient-to-r ${currentQuote.color}`}
                    data-id="og0oyp64l"
                    data-path="src/pages/QuotesPage.tsx"
                  ></div>
                  <CardContent className="p-8 md:p-12" data-id="f5r2bcbs7" data-path="src/pages/QuotesPage.tsx">
                    <div className="text-center" data-id="yw6wgjshu" data-path="src/pages/QuotesPage.tsx">
                      <motion.div
                        ...
                        className={`w-16 h-16 mx-auto mb-6 rounded-full bg-gradient-to-r ${currentQuote.color} flex items-center justify-center`}
                        data-id="dvo05yr3f"
                        data-path="src/pages/QuotesPage.tsx"
                      >
                      ...
                      >
                        ...
                        <span
                          className={`inline-block px-3 py-1 mt-2 text-sm font-semibold rounded-full bg-gradient-to-r ${currentQuote.color} text-white`}
                          data-id="5ro7uonfr"
                          data-path="src/pages/QuotesPage.tsx"
                        >
        ...
        >
          <Button
            ...
            disabled={isLoading}
            size="lg"
            className="bg-gradient-to-r from-indigo-500 to-cyan-500 hover:from-indigo-600 hover:to-cyan-600 text-white px-8 py-4 text-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-xl"
            data-id="0m56bccg4"
            data-path="src/pages/QuotesPage.tsx"
          >
            {isLoading ? (
        ...
        {favoriteQuotes.length > 0 && (
          ...
          >
            ...
            >
              ...
              <Heart
                className="inline-block ml-2 h-8 w-8 text-red-500 fill-current"
                data-id="36vtfoxw1"
                data-path="src/pages/QuotesPage.tsx"
              />
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6" data-id="58315ym9p" data-path="src/pages/QuotesPage.tsx">
              {favoriteQuotes.map((quote, index) => (
                ...
                >
                  ...
                  >
                    <div
                      className={`h-1 bg-gradient-to-r ${quote.color}`}
                      data-id="fv59x0ski"
                      data-path="src/pages/QuotesPage.tsx"
                    ></div>
                    <CardContent className="p-6" data-id="oe9ni2vix" data-path="src/pages/QuotesPage.tsx">
                      ...
                      <div className="flex justify-between items-center" data-id="eqjaks29j" data-path="src/pages/QuotesPage.tsx">
                        <div data-id="i7969lrgs" data-path="src/pages/QuotesPage.tsx">
                          <p className="text-gray-600 font-medium" data-id="zalmhkq7y" data-path="src/pages/QuotesPage.tsx">
                            — {quote.author}
                          </p>
                          <span
                            className={`inline-block px-2 py-1 mt-1 text-xs font-semibold rounded-full bg-gradient-to-r ${quote.color} text-white`}
                            data-id="271v1jha9"
                            data-path="src/pages/QuotesPage.tsx"
                          >
                            {quote.category}
        ...
        >
          ...
          <h2 className="text-3xl font-bold mb-4" data-id="axy55n4pb" data-path="src/pages/QuotesPage.tsx">
          ...
          <Button
            size="lg"
            onClick={handleTrackingClick} // Add onClick handler
            className="bg-white text-indigo-600 hover:bg-gray-100 px-8 py-4 text-lg font-semibold transition-all duration-300 transform hover:scale-105"
            data-id="5ug6wa7eo"
            data-path="src/pages/QuotesPage.tsx"
          >
